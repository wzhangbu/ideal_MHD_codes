Here is a comprehensive `README.md` file tailored to your complete project, including the new files (`dipole.py`, `OCB_GM.py`, `OCB_at_9RE.py`, `calc.py`, etc.). You can copy and paste this directly into your repository.
